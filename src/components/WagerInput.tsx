  ...
  return (
    <div ref={ref} className={props.className} style={{ position: 'relative' }}>
      <StyledWagerInput $edit={isEditing}>
        <Flex onClick={() => !whisky.isPlaying && startEditInput()}>
        ...
        {!props.options && (
          <Buttons>
            <InputButton disabled={whisky.isPlaying} onClick={() => props.onChange(props.value / 2)}>
              x.5
            </InputButton>
            <InputButton disabled={whisky.isPlaying} onClick={x2}>
              x2
            </InputButton>
          </Buttons>
        )}
